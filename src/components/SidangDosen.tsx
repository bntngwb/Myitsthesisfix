...
import { 
  BookOpen, Calendar, Users, Search, Eye, 
...
interface Sidang {
  ...
  jenisSidang: string;
  periode: string;
  statusPengerjaan: "Menunggu" | "Dalam Sidang" | "Perlu Dinilai" | "Pengerjaan Revisi" | "Perlu Approval" | "Selesai";
  statusRole: "Ketua Sidang" | "Penguji" | "Pembimbing";
  tanggal: string;
  judul: string;
}

export function SidangDosen() {
