...
export function BerandaDosen({ announcements, onNavigate, onAnnouncementClick }: BerandaDosenProps) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-gray-800 text-2xl font-[Poppins] font-medium font-bold">Selamat Datang, Bintang Hanoraga</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div>
              <h2 className="text-gray-800 mb-4 font-[Poppins] text-[16px] font-bold font-normal">Menunggu Persetujuan Anda</h2>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 relative hover:shadow-lg transition-shadow duration-200 cursor-pointer">
                  <div className="mb-3">
                    ...
                    <h3 className="text-gray-800 mb-1 font-[Poppins]">Ajuan Proposal</h3>
                    <p className="text-sm text-gray-500 font-[Roboto]">5 ajuan baru</p>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 relative hover:shadow-lg transition-shadow duration-200 cursor-pointer">
                  <div className="mb-3">
                    ...
                    <h3 className="text-gray-800 mb-1 font-[Poppins]">Ajuan Sidang</h3>
                    <p className="text-sm text-gray-500 font-[Roboto]">3 ajuan baru</p>
                  </div>
                  <button className="absolute bottom-3 right-3 w-7 h-7 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center">
                    <ChevronRight className="w-4 h-4" />
                  </button>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 relative hover:shadow-lg transition-shadow duration-200 cursor-pointer">
                  <div className="mb-3">
                    ...
                    <h3 className="text-gray-800 mb-1 font-[Poppins]">Ajuan Bimbingan</h3>
                    <p className="text-sm text-gray-500 font-[Roboto]">7 ajuan baru</p>
                  </div>
                  <button className="absolute bottom-3 right-3 w-7 h-7 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center">
                    <ChevronRight className="w-4 h-4" />
                  </button>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-[Roboto]">Mahasiswa dalam bimbingan</p>
                  </div>
                </div>
                <button 
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-lg transition-shadow duration-200">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-[Roboto]">Jadwal dan penilaian</p>
                  </div>
                </div>
                <button 
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-lg transition-shadow duration-200">
                  <div>
                    <p className="text-gray-800 font-[Poppins] mb-1">Sidang Mendatang</p>
                    <p className="text-xs text-gray-500 font-[Roboto] mb-2">Mendatang:</p>
                    <p className="text-2xl text-green-600 font-[Poppins]">3</p>
                  </div>
                </div>

                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-lg transition-shadow duration-200">
                  <div>
                    <p className="text-gray-800 font-[Poppins] mb-1">Penilaian Sidang</p>
                    <p className="text-xs text-gray-500 font-[Roboto] mb-2">Harus dinilai:</p>
                    <p className="text-2xl text-yellow-600 font-[Poppins]">10</p>
                  </div>
                </div>

                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-lg transition-shadow duration-200">
                  <div>
                    <p className="text-gray-800 font-[Poppins] mb-1">Revisi Sidang</p>
                    <p className="text-xs text-gray-500 font-[Roboto] mb-2">Revisi pending:</p>
                    <p className="text-2xl text-red-600 font-[Poppins]">7</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          steps={[
            {
              ...
              description: "myITS Thesis adalah platform untuk mengelola bimbingan dan sidang mahasiswa. Di sini Anda dapat menerima permintaan bimbingan, menilai sidang, dan memantau progress mahasiswa bimbingan. Gunakan menu utama untuk mengakses fitur-fitur dengan mudah.",
            ...
            },
            {
              ...
              description: "Menu Permintaan Bimbingan menampilkan mahasiswa yang meminta Anda sebagai pembimbing. Terdapat 2 kategori: Proposal Baru (proposal yang baru diajukan) dan Tugas Akhir (request untuk tahap TA). Klik kartu untuk melihat detail dan setujui atau tolak permintaan bimbingan.",
              imageUrl: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHVkZW50JTIwbWVldGluZ3xlbnwxfHx8fDE3Mzc4MDAwMDB8MA&ixlib=rb-4.1.0&q=80&w=1080"
            },
            {
              title: "Sidang dan Penilaian",
              description: "Menu Sidang membantu Anda mengelola jadwal sidang mahasiswa. Penilaian Sidang menunjukkan sidang yang perlu dinilai, Sidang Mendatang untuk jadwal sidang dalam waktu dekat, dan Revisi Pending untuk sidang yang memerlukan revisi. Pastikan Anda menyelesaikan penilaian tepat waktu.",
              imageUrl: "https://images.unsplash.com/photo-1531482615713-2afd69097998?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVzZW50YXRpb24lMjBtZWV0aW5nfGVufDF8fHx8MTczNzgwMDAwMHww&ixlib=rb-4.1.0&q=80&w=1080"
            },
            {
              title: "Bimbingan Aktif",
              description: "Menu Bimbingan Aktif menampilkan daftar mahasiswa yang sedang Anda bimbing, dikelompokkan berdasarkan jenjang (Sarjana/Magister). Di halaman ini Anda dapat melihat progress setiap mahasiswa, memberikan catatan bimbingan, dan memonitor timeline pengerjaan tugas akhir mereka.",
              imageUrl: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHVkZW50cyUyMGdyb3VwJTIwc3R1ZHlpbmd8ZW58MXx8fHwxNzM3ODAwMDAwfDA&ixlib=rb-4.1.0&q=80&w=1080"
            }
          ]}
        />
      )}
